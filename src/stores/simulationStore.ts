...
import { subscribeTimeline, getCurrentMinute } from "./timelineStore";
...
let currentState = getSimulationState(currentCity, getCurrentMinute());

function recompute() {
  currentState = getSimulationState(currentCity, getCurrentMinute());
